...
/// <summary>Represents a single bank transaction (STMTTRN) from an OFX statement.</summary>
public sealed record BankTransaction(
    ...
    string FitId,
    /// <summary>The name or description of the transaction (e.g., payee name).</summary>
    string? Name = null,
    /// <summary>Additional memo or description text.</summary>
    string? Memo = null,
    /// <summary>The check number, if applicable.</summary>
    ...
    /// <summary>The FITID of the transaction being corrected, for reversals.</summary>
    string? CorrectFitId = null,
    /// <summary>The corrective action type (e.g., RER for reversal).</summary>
    string? CorrectiveAction = null,
    /// <summary>The server-assigned transaction identifier, if available.</summary>
